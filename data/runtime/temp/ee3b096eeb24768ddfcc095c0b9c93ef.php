<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"C:\mywamp\Apache24\htdocs\shen\themes\pc\mp\message\replymsg.html";i:1509527512;s:69:"C:\mywamp\Apache24\htdocs\shen\themes\pc\mp\..\admin\common\base.html";i:1509527512;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <td>
                <div class="layui-row rha-mp-msg ">
                    ...
                    <div class="mp-msg-info layui-col-md10">
                        ...
                        <p class="mp-msg-content" style="overflow: visible;"><?php echo $vo['content']; ?></p>
                    </div>
                </div>
            </td>
            <td><?php echo $vo['create_time']; ?></td>
            <td><a class="rha-bt-a" href="javascript:;" onclick="delMsg('<?php echo $vo['msg_id']; ?>','<?php echo $vo['openid']; ?>')">删除</a> </td>
        </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
        </tbody>
    </table>
...
<script>
    ...
    function delMsg(id,openid) {
        layui.use('layer', function(){
            ...
            layer.confirm('你确定需要删除吗？', {
                ...
                $.post("<?php echo url('message/delMsg'); ?>",{'id':id,'openid':openid},function (res) {
                    if(res.status==1){
                        layer.close(load);
                        layer.msg(res.msg,{time:2000},function (index) {
                            window.location.reload();
    ...
    layui.use('upload', function(){
        ...
        var uploadInst = upload.render({
            elem: '#replyMsgImg'
            ,url: "<?php echo url('replyImgByMsg',['openid'=>$openid]); ?>"
